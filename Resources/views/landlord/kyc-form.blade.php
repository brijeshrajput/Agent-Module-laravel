    ...
    <div class="col-lg-12 col-ml-12">
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__("Edit Agent KYC Form")}}</h4>
                        <br>
                        <form action="{{ route('landlord.admin.agent.kyc.form.update') }}" method="Post">
                            @csrf
                            <input type="hidden" name="id" value="">
                            <div class="form-group">
                                <label for="text">{{__('Title')}}</label>
                                <input type="text" class="form-control" name="title" value="KYC form">
                            </div>
                            
                            {!! \App\Helpers\FormBuilderCustom::render_drag_drop_form_builder($form_data) !!}
