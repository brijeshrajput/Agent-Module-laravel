            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="login-form-wrapper custom--form signIn-signUp-wrapper">
                        ...
                        <form action="{{route('landlord.agent.forget.password.send')}}" method="post" enctype="multipart/form-data" class="contact-page-form style-01">
                            @csrf
                            <div class="form-group single-input">
                                <input type="email" name="email" class="form-control form--control" placeholder="{{__('Email')}}">
                            </div>
