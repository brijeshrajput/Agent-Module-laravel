            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="login-form-wrapper signin-contents">.
                        ...
                        <x-error-msg/>
                        <x-flash-msg/>
                        <form action="{{route('landlord.agent.reset.password.change')}}" method="post" enctype="multipart/form-data" class="contact-page-form style-01">
                            @csrf
                            <input type="hidden" name="token" value="{{$token}}">
                            <div class="form-group single-input">
                                <input type="text" id="email" class="form-control form--control mt-3" readonly value="{{$email}}" name="email">
                            </div>
                            <div class="form-group single-input">
