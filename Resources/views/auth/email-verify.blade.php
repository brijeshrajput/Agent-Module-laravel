               ...
               <div class="col-lg-6">
                   <div class="contact-form-wrapper wrapper-verify">
                       ...
                       <div class="custom-form mt-4">
                           <x-flash-msg/>
                           <x-error-msg/>
                           <form action="{{route('landlord.agent.email.verify.check')}}" method="post">
                               @csrf
                               ...
                               <div class="extra-wrap margin-top-20">
                                   <span>{{__('Do not get code?')}} <a href="{{route('landlord.agent.email.verify.resend')}}" class="color-one">{{__('Resend code')}}</a></span>
                               </div>
                           </form>
                       </div>
                   </div>
