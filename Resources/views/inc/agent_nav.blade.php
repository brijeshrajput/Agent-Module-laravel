            ...
            <div class="d-flex justify-content-around align-items-center align-items-stretch">
                <div class="aiz-topbar-item">
                    <div class="d-flex align-items-center">
                        <a class="btn btn-icon btn-circle btn-light" href="{{ route('landlord.agent.dashboard')}}" target="_blank" title="{{ __('Browse Agent Dashboard') }}">
                ...
                <div class="align-items-stretch d-flex dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-lg py-0">
                        ...
                        <div class="text-center border-top">
                            <a href="{{ route('landlord.agent.notifications') }}" class="text-reset d-block py-2">
                    ...
                    <a class="dropdown-toggle no-arrow text-dark" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <span class="avatar avatar-sm mr-md-2">
                                @php
                                    if (auth('agent')->user()->image != null)
                                    {
                                        $image_id = auth('agent')->user()->image;
                                    } else {
                                ...
                                {{-- <img src="{{ uploaded_asset(Auth::user()->avatar_original) }}"
                                    onerror="this.onerror=null;this.src='{{ asset('assets/landlord/uploads/media-uploader/no-image.jpg') }}';"> --}}
                            </span>
                            <span class="d-none d-md-block">
                                <span class="d-block fw-500">{{ auth('agent')->user()->name }}</span>
                                <span class="d-block small opacity-60">Agent</span>
                            </span>
                        </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-md">
                        <a href="{{ route('landlord.agent.edit.profile') }}" class="dropdown-item">
                            <i class="las la-user-circle"></i>
                            <span>{{ __('Profile') }}</span>
                        </a>

                        <a href="{{ route('landlord.agent.logout')}}" class="dropdown-item">
